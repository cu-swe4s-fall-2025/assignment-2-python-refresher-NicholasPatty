def get_column(file_name, query_column, query_value, result_column=1):
    """
    This function reads a CSV file and retrieves values from a specified column (query_column)
    based on a matching condition in another column (query_value) and returns values from the result_column.
    ...
    result_column (int or str): The index or name of the column from which to retrieve values when a match is found. Defaults to 1.

    Returns:
    ------------
    list: A list of values from the result_column where the query_column matches the query_value
    """
